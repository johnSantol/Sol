...
$qry = $conn->query("UPDATE `forms` SET `Form2Status`='1' WHERE LoginID = $selected;");
}}}
?>

<center><div class="card" style="width: 60%"><br> 
 <center><h2 >Psychotheraphy Form</h2></center>
...
<p>I fully understand that the service provided by the Sol Psychological Services will  accumulate the total amount of <b>TWO THOUSAND PESOS</b> (2,000.00) only for the whole course of the evaluation until the release of my psychological evaluation report.</p>
<p>I agree that I must pay  the amount of <b>TWO THOUSAND PESOS</b> (2,000.00) upon testing administration and release of the psychological evaluation report.</p>
<p style="text-indent: 30px;"><b>B. Informed Consent</b></p>
<p>I understand that the facilitation of different psychological interventions involves the completion of a series of psychological tests and clinical interview. The total amount the time of the facilitation of different psychological interventions may vary and will depend upon the questions that I or the clincian may have.</p>
<p>I understand that I or the clinician may experience emotional distress because of the personal nature of some of the information solicited in the facilitation of different psychological interventions process. In this regard, I or the clinician, may interrupt or discontinue this facilitation of different psychological interventions procedure at any time.</p>
<p>I solemnly attest that all information that I will give to this facilitation of different psychological interventions is true and correct to the best of my knowledge.</p>
