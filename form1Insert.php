...
<?php
    ...
    $sql = "INSERT INTO `form1`(ID, FullName, Birthday, Gender, CivilStatus, Religion, BirthOrder, Address, HouseNo, Barangay, TownCity, Province, MobileNumber, EmailAddres) VALUES ('5','$cname','$cbday','$cgender','$ccv','$creligion','$cbo','$caddress','$chouse','$cbarangay','$ctowncity','$province','$mobilenumber','$cemail');";
